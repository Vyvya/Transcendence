...
function navigateTo(sectionId) {
    ...
    // Start or stop particles script based on the section
    if (sectionId === 'home') {
        console.log('Navigating to home, starting particles');
        startParticles(); // Start particles when navigating to home
    } else {
        console.log('Navigating away from home, stopping particles');
        stopParticles(); // Stop particles when navigating away from home
    }
